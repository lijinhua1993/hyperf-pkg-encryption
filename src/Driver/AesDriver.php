...
namespace HyperfLjh\Encryption\Driver;

use HyperfLjh\Encryption\Contract\SymmetricDriverInterface;
...
class AesDriver implements SymmetricDriverInterface
{
     ...
     * @param  mixed  $value
     *
     * @throws \HyperfLjh\Encryption\Exception\EncryptException
     */
     ...
     *
     * @throws \HyperfLjh\Encryption\Exception\DecryptException
     */
